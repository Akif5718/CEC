...
const SignIn = (props: Props) => {
  ...
  return (
    <>
      ...
      <div className="mt-10 bg-slate-700 w-full h-[100vh] flex justify-center items-center">
        {/* <div className="block w-1/4 z-[0]">Akifs Peoject</div> */}
        <div className="block md:w-1/4 w-2/4 z-[0]">
          {/* Main Card */}
