...
File.WriteAllText(basePath+"/CEC.Models/ViewModels/"+ $"{settings.ClassName}Model.cs", modelResult, Encoding.UTF8);
File.WriteAllText(basePath+"/CEC.Models/ResponseModels/"+ $"{settings.ClassName}ResponseModel.cs", responseResult, Encoding.UTF8);
File.WriteAllText(basePath + "/CEC.Repositories/Interface/" + $"I{settings.RepoName}.cs", irepoResult, Encoding.UTF8);
File.WriteAllText(basePath + "/CEC.Repositories/" + $"{settings.RepoName}.cs", repoResult, Encoding.UTF8);
File.WriteAllText(basePath + "/CEC.Services/Interface/" + $"I{settings.ServiceName}.cs", iserviceResult, Encoding.UTF8);
File.WriteAllText(basePath + "/CEC.Services/" + $"{settings.ServiceName}.cs", serviceResult, Encoding.UTF8);
